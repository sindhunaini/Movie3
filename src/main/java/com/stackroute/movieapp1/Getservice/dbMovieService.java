...
public class dbMovieService implements MovieService{
    ...
    MovieRdmsRepo movieRdmsrepo;
        ...
        public MovieRdmsRepo getMovieRdmsrepo() {
		return movieRdmsrepo;
	}



	public void setMovieRdmsrepo(MovieRdmsRepo movieRdmsrepo) {
		this.movieRdmsrepo = movieRdmsrepo;
	}
...
//         }
    ...
    public MovieModel getMovie(String id) {
        ...
        return movieRdmsrepo.findOne(id);
	...
	public MovieModel findById(String id) {
		// TODO Auto-generated method stub
		return movieRdmsrepo.findById(id);
	}
